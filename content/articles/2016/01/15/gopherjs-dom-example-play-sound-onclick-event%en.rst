...
This example shows how to play sound when a HTML element is clicked.
...
will be called to play the sound of the mp3 file, which is
...
directory. Open the *index.html* with your browser. Click the button and you
will hear the sound!
...
- `[Golang] GopherJS DOM Example - Toggle (Play/Pause) Sound on Click Event <{filename}gopherjs-dom-example-toggle-sound-onclick-event%en.rst>`_
